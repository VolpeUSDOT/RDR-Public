...
suppressPackageStartupMessages(library(lme4)) # used for 'mixedeffects' method
suppressPackageStartupMessages(library(mlegp)) # Gaussian Process regression for multitarget option
suppressPackageStartupMessages(library(nlme)) # used for 'projgroupLM' method
