...
def start_page(go_to:str = 'sequential') -> None:
...
def set_dirs(go_to:str = 'sequential') -> None:
    parameter = params.input_dir ## Essential parameter
    ...
    parameter = params.output_dir ## Essential parameter
    ...
    parameter = params.run_id ## Essential parameter
...
def set_years(go_to:str = 'sequential') -> None:
    parameter = params.start_year ## Essential parameter
    ...
    parameter = params.end_year ## Essential parameter
    ...
    parameter = params.base_year ## Essential parameter
    ...
    parameter = params.future_year ## Essential parameter
    ...
    os.system('cls')
    set_metamodel_essential(go_to)

# ===================
# METAMODEL VALUES
# ===================

def set_metamodel_essential(go_to:str = 'sequential') -> None:
    
    parameter = params.lhs_sample_target  ## Essential
    ...
    os.system('cls')
    set_disruption_essential(go_to)

# ===================
# DISRUPTION VALUES
# ===================

def set_disruption_essential(go_to:str = 'sequential') -> None:
    parameter = params.exposure_field  ## Essential
    ...
    parameter = params.highest_zone_number  ## Essential
    ...
    os.system('cls')
    set_recovery_essential_1(go_to)

# ===================
# RECOVERY VALUES
# ===================

def set_recovery_essential_1(go_to:str = 'sequential') -> None:
    ...
    os.system('cls')
    set_recovery_essential_2(go_to)

def set_recovery_essential_2(go_to:str = 'sequential') -> None:
    ...
    os.system('cls')
    set_recovery_essential_3(go_to)

def set_recovery_essential_3(go_to:str = 'sequential') -> None:
    ...
    os.system('cls')
    set_analysis_essential(go_to)

# ===================
# ANALYSIS VALUES
# ===================

def set_analysis_essential(go_to:str = 'sequential') -> None:

    parameter = params.roi_analysis_type  ## Essential
    ...
    parameter = params.dollar_year  ## Essential
    ...
    parameter = params.crs ## Essential
    message = "Coordinate Reference System\nOnly use if TrueShape.csv file is provided. Otherwise, press Enter.\nSpecifies the EPSG:XXXX CRS identifier for the TrueShape coordinate reference system. \nType ONLY the XXXX part."
    if go_to in [parameter.short, 'sequential']:
        params.current_param.value = parameter.short
        uinput = ut.build_input(parameter, message, char_floor = 0, char_ceiling = 100, illegal_chars = [':'])
        if uinput != '':
...
def set_haz(go_to:str = 'sequential') -> None:
    parameter = params.hazards ## Essential
...
def set_eff(go_to:str = 'sequential') -> None:
    parameter = params.event_frequency_factors ## Essential
...
def set_ecf(go_to:str = 'sequential') -> None:
    parameter = params.economic_futures ## Essential
...
def set_tle(go_to:str = 'sequential') -> None:
    parameter = params.trip_loss_elasticities ## Essential
...
def set_rep(go_to:str = 'sequential') -> None:
    parameter = params.resilience_projects ## Essential
...
def set_netlink(go_to:str = 'sequential') -> None:  # Should not be able to jump to this without setting rep and ecf
    parameter = params.network_links ## Essential
...
def set_other_1(go_to:str = 'sequential') -> None:
    parameter = params.net_node ## Essential
    ...
    parameter = params.proj_table ## Essential
    ...
    parameter = params.proj_info ## Essential
...
def set_other_2(go_to:str = 'sequential') -> None:
    ...
    parameter = params.base_year_file ## Essential
...
def set_bat(go_to:str = 'sequential') -> None:

    # Only allows entry into set_bat through a short or sequentially
    if go_to not in [params.python.short, params.rdr.short, params.bat_location.short, 'sequential']:
        os.system('cls')
        end_essential(go_to)

    parameter = params.python ## Essential
    ...
    parameter = params.rdr ## Essential
    ...
    parameter = params.bat_location ## Essential
...
def end_essential(go_to:str = 'sequential') -> None:
    if go_to == 'sequential':
        input('\n\n\n      Done setting essential RDR parameters. RDR is ready to run.\n      RDR will now save. Press Enter key to continue...')
        ut.quick_save(params.save_file, params.param_list, go_to = params.current_param.value)
        uinput = input('\n\n\n      Save successful. \n      Press Enter key to continue to non-essential RDR parameters, or type "-mm" to return to Main Menu.')
        ui.universal_commands(uinput)
    os.system('cls')
...
# No non-essential common values

# ===================
# METAMODEL VALUES
# ===================
def set_metamodel_1(go_to:str = 'sequential') -> None:
...
def set_metamodel_2(go_to:str = 'sequential') -> None:
...
def set_disruption_1(go_to:str = 'sequential') -> None:
...
def set_disruption_beta(go_to:str = 'sequential') -> None:
...
def set_disruption_2(go_to:str = 'sequential') -> None:
...
def set_recovery_1(go_to:str = 'sequential') -> None:
...
def set_analysis_5(go_to:str = 'sequential') -> None:
...
# No non-essential non-config
    
# ===================
# BAT VALUES
# ===================
    
# No non-essential BAT values

# ===================
# END NON-ESSENTIAL
# ===================
    
def end_page(go_to: str) -> None:
    if go_to == 'sequential':
    ...
    # Catches attempts to access param shorts that are hidden behind conditionals
        # for other param settings, like 'if params.example1 == x: build_input(params.example2)'    
    if go_to in params.shorts:
        uinput = input('\n\n\n      -{} is hidden behind another parameter setting and\n      is unused in the current parameter configuration.\n\n\n      Type -mm for main menu, -cc for the current parameter, or -h for help and press Enter...\n      >>'.format(go_to))
        os.system('cls')
        if uinput != '':
            ui.universal_commands(uinput)
        ui.main_menu()
