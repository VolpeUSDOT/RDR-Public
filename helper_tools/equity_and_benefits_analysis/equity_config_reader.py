...
def read_equity_config_file(cfg_file):
    ...
    cfg_dict['TAZ_mapping'] = read_config_file_helper(cfg, 'equity_analysis', 'TAZ_mapping', 'REQUIRED')
    ...
    run_type = read_config_file_helper(cfg, 'equity_analysis', 'run_type', 'OPTIONAL')
